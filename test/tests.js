...
var gypMerge = require('..');

test("simple dictionary vs simple dictionary", function(t) {
    var out = gypMerge.mergeDictionary( { a: 1, b: "test" }, { a: 2, c: "new" });
...
test("recursive dictionary merge", function(t) {
    var out = gypMerge.mergeDictionary( { a: { b: { c: 1 } } }, { a: { b: { d: 2 }, f: 1 }, e: 3 } );
...
test("dictionary with list merges", function(t) {
    var out = gypMerge.mergeDictionary(
